...
<div class="nav_wrapper">
    ...
    <ul class="nav">
       ...
       <a href="/pages/reqSaleGood.do"> <li class="focus">9.9特卖</li></a>
...
<div class="banner_group">
    <div class="banner_faker">
            ...
            <img src="../imgs/goods/sale_goods/sale.jpg">
        <div class="float">
            ...
            font-size: 24px;
            line-height: 56px;
            margin-top: 4px;">9.9特卖
            </div>
            <div class="desc" style="
            color: #686868;
            font-size: 16px;
            line-height: 30px;
            padding-bottom: 13px;">全场9.9元起，9.9你也买得了上当受骗
            </div>
