...
<div class="nav_wrapper">
    ...
    <ul class="nav">
        ...
        <a href="/pages/reqSupermarketGood.do"> <li class="focus">食品超市</li></a>
...
<div class="banner_group">
    <div class="banner_faker">
        ...
        <img src="../imgs/goods/supermarket_goods/supermarket.jpg">
        <div class="float">
            ...
            font-size: 16px;
            line-height: 30px;
            padding-bottom: 13px;">随便选垃圾食品，品种有限，爱要不要！
            </div>
